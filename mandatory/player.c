...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/09 17:37:18 by librahim          #+#    #+#             */
/*   Updated: 2025/04/09 18:37:51 by mjuicha          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cast_one_ray(t_game *game, double angle, int ray)
{
	...
	game->wallx[ray] = shortest_dist(h_dis, v_dis, game->hor_x_intercept,
			game->ver_x_intercept);
	game->wally[ray] = shortest_dist(h_dis, v_dis, game->hor_y_intercept,
